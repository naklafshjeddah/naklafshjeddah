            ...
            {isArabic ? (
              <>
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  وأهمية وصولها سليمة إلى وجهتها الجديدة. لهذا نقدم لك خدمات نقل عفش احترافية
                  بجدة مبنية على سنوات من الخبرة والتزام حقيقي بجودة الخدمة.
                </p>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  وحتى تطمئن على آخر قطعة أثاث في منزلك الجديد. خدماتنا تشمل:
                </p>

                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  <li>
                    <strong>معاينة مجانية:</strong> نزور موقعك لتقييم دقيق وعرض سعر شفاف بدون
                    تكاليف خفية
                  </li>
                  <li>
                    <strong>تغليف احترافي:</strong> نستخدم مواد تغليف عالية الجودة (كراتين
                    مقوى، فقاعات، أغطية واقية) لحماية كل قطعة
                  </li>
                  <li>
                    <strong>فك وتركيب متخصص:</strong> فريقنا خبير في فك وتركيب جميع أنواع
                    الأثاث بما في ذلك غرف النوم، المطابخ، المكيفات، والستائر
                  </li>
                  <li>
                    <strong>معدات حديثة:</strong> نمتلك ونش هيدروليكي ورافعات آمنة لنقل
                    القطع الثقيلة من الأدوار العليا
                  </li>
                  <li>
                    <strong>سيارات مجهزة:</strong> أسطول من الشاحنات المغلقة المجهزة بأنظمة
                    تثبيت لمنع الحركة والخدوش
                  </li>
                  <li>
                    <strong>تخزين آمن:</strong> مخازن حديثة مراقبة ومكيفة لتخزين عفشك قصير أو
                    طويل المدى
                  </li>
                </ul>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  سواء كنت تنتقل داخل نفس الحي أو من طرف جدة للآخر، نحن نغطي كل المناطق: الحمراء،
                  الروضة، الشاطئ، السلامة، النعيم، المرجان، الرحاب، النهضة، الزهراء، البوادي،
                  الربوة، الصفا، الخالدية، الأندلس، العزيزية، البلد، الرويس، بني مالك، الورود،
                  النسيم، أبحر الشمالية والجنوبية، وجميع الأحياء الأخرى. كما نقدم خدمات نقل بين
                  المدن من وإلى الرياض، مكة، المدينة، الطائف، وباقي مدن المملكة.
                </p>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  نحن نؤمن بالشفافية الكاملة. تكلفة النقل تعتمد على عوامل واضحة: حجم المنزل، عدد
                  الغرف، كمية الأثاث، المسافة، الطابق، وجود مصعد، والخدمات الإضافية. نقدم معاينة
                  مجانية لتحديد سعر دقيق قبل البدء، ولا نفاجئك بتكاليف إضافية. أسعارنا تنافسية
                  وعادلة مع التركيز على الجودة لا الكمية.
                </p>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  <li>رتّب الأغراض وتخلص من غير المستخدم لتقليل الحجم والتكلفة</li>
                  <li>صور الأثاث الثمين قبل النقل كتوثيق</li>
                  <li>أفرغ الأدراج والخزانات من المحتويات الشخصية</li>
                  <li>احتفظ بالمستندات والمقتنيات الثمينة معك شخصياً</li>
                  <li>احجز موعد النقل مبكراً خاصة في مواسم الذروة</li>
                </ul>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  بعد إتمام النقل والتركيب، لا ينتهي دورنا. نتابع معك للتأكد من رضاك الكامل،
                  ونبقى على تواصل لأي استفسارات أو احتياجات إضافية. ضماننا يشمل إصلاح أو تعديل أي
                  مشكلة في التركيب خلال فترة محددة. رضاك هو هدفنا ونجاحنا.
                </p>
              </>
            ) : (
              <>
